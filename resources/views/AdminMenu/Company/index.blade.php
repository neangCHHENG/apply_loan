                ...
                <table id="datalist" class="table table-bordered table-hover table-striped w-100"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="text-align:center!important">External Url</th>
                            <th style="text-align:center!important">Facebook Url</th>
...
@include('AdminMenu.Company.form')
<script>
    {
        var idEdit = null;
        ...
        function update() {
            if (0 === 0) {
                $.ajax({
                    url: "{{ url('/api/admin/company') }}/" + idEdit,
                    type: "PUT",
                    data: valueFil(),
                    beforeSend: function(xhr) {
                        blockagePage('Please Wait...');
    ...
    function getDepartmentList() {
        $.ajax({
            ...
            success: function(response) {
                ...
                $("#formModal #department").html(typeStr);
                $("#formModal #department").select2("destroy").select2({
                    dropdownParent: $('#formModal')
                });
                unblockagePage();
            },
