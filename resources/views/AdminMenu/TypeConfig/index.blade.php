                ...
                <table id="datalist" class="table table-bordered table-hover table-striped w-100"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="text-align:center!important">Config Value</th>
...
@include('AdminMenu.TypeConfig.form')
<script>
    {
        var idEdit = null;
        ...
        function update() {
            if (0 === 0) {
                $.ajax({
                    url: "{{ url('/api/admin/type-config') }}/"+idEdit,
                    type: "PUT",
                    data: valueFil(),
                    beforeSend: function(xhr) {
                        blockagePage('Please Wait...');
        ...
        function destroy(id) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{ url('/api/admin/type-config') }}/"+id,
                        type: "DELETE",
                        beforeSend: function(xhr) {
                            blockagePage('Please Wait...');
                            xhr.setRequestHeader('Authorization', 'Bearer ' + AuthToken);
