<div class="col-xl-12">
    <div id="panel-1" class="panel">
        <div class="panel-hdr">
            <h2>
                Benefit <span class="fw-300"><i>List</i></span>
            </h2>
...
@include('AdminMenu.Benefit.form')
<script>
    {
        var idEdit = null;
        ...
        function update() {
            if (0 === 0) {
                $.ajax({
                    url: "{{ url('/api/admin/benefit') }}/" + idEdit,
                    type: "PUT",
                    data: valueFil(),
                    beforeSend: function(xhr) {
                        blockagePage('Please Wait...');
